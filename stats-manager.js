//TODO: when remote is down, retries
//TODO: decide whether or not to auto refresh here
//TODO: if past season, check persistence or cache first
//TODO: prime/precache hot players/data
var _ = require("underscore");
var appErrors = require('./errors');

var cacheManager = require('./cache-manager')
var persistenceManager = null; //TODO

module.exports = function(riot, logger) {
    if (!riot) {
        throw new Error('Riot client must be provided');
    }
    if (logger === undefined) {
        throw new Error('Logger must be provided');
    }

    var setRefreshedDate = function(obj) {
        if (obj) {
    ...
    //TODO: if 404, may not want to evict it so fast, if 403 log notify fatal error, etc
    var evict = function(cacheKey, err) {
    ...
    var self = {
        //TODO: integrity: client legitimate can ask for a championId that does not exist here?
        ...
        getSummonerNames: function(region, summonerIds) { //TODO: forceRefresh (seldom change)
        ...
        //TODO: Matches (games) can be persisted, forceRefresh is not applicable here
